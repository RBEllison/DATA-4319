...
The dataset we will be using to implement the percpetron algorithm is the iris dataset from the R base library. The two independent variable
...
ggplot(data,aes(x = data[, 1], 
  ...
  labs(x = "Sepal Length", 
       y = "Sepal Width") + 
  ggtitle("Species : Setosa and Versicolor")
